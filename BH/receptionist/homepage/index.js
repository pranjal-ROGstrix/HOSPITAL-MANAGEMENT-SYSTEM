(function () {
    ...
    app.config(function ($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
            ...
            .state('patientunderdoctor', {
                url: '/patientunderdoctor',
                templateUrl: 'patientunderdoctor.html',
                controller: 'patientunderdoctorCtrl as docpatCtrl'
            })
    ...
    app.controller('patientunderdoctorCtrl', function ($http) {
        let docpatCtrl = this;
        $http({
                method: 'GET',
                url: url + 'Manager_login/doctor_registration/accept/list',
            })
            .then(
                function mySuccess(response) {
                    docpatCtrl.doclist = response.data;
                    console.log(response.data)
                }
            )
        docpatCtrl.getpatientdetails = function () {
            $http({
                    method: 'POST',
                    url: url + 'doctor_dashboard/count/',
                    data: {
                        'doctor_name': docpatCtrl.selecteddoctor
                    }
                })
                .then(
                    function mySuccess(response) {
                        console.log(response)
                        docpatCtrl.patient_list = response.data;
                    }
                )
        }
    })
    ...
    app.controller('reportCtrl', function ($http) {
        ...
        $http({
                method: 'GET',
                url: url + 'Manager_dashboard/report/'
            })
            .then(
                function mySuccess(response) {
                    repCtrl.reports = response.data;
                    console.log(response);
                }
            )
    })
